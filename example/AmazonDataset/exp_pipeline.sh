...
java -Xmx4g -jar /home/laknaren/workspace/drem-attention/utils/AmazonDataset/jar/AmazonReviewData_preprocess.jar false ./reviews_Sports_and_Outdoors_5.json.gz ./reviews_Sports_and_Outdoors_5.processed.gz
# Index datasets
python /home/laknaren/workspace/drem-attention/utils/AmazonDataset/index_and_filter_review_file.py reviews_Sports_and_Outdoors_5.processed.gz ./tmp_data/ 5
# Match the meta data with the indexed data to extract queries:
java -Xmx16G -jar /home/laknaren/workspace/drem-attention/utils/AmazonDataset/jar/AmazonMetaData_matching.jar false ./meta_Sports_and_Outdoors.json.gz ./tmp_data/min_count5/
# Gather knowledge from meta data:
python /home/laknaren/workspace/drem-attention/utils/AmazonDataset/match_with_meta_knowledge.py ./tmp_data/min_count5/ meta_Sports_and_Outdoors.json.gz
...
python3 /home/laknaren/workspace/drem-attention/utils/AmazonDataset/collect_time_seq_info.py tmp_data/min_count5 ./reviews_Sports_and_Outdoors.json.gz
